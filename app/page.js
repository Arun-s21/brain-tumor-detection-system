...
import AnimatedStatistics from './Component/AnimatedStatistics';
...
export default function LandingPage() {
  return (
    ...
    <div className="relative w-full flex flex-col font-sans">
      ...
      {/* Background Image & Overlay - Now fixed to cover the entire viewport */}
      ...
      {/* All content is now wrapped in a single main tag for proper structure */}
      <main className="relative z-10">
        ...
        <section className="flex h-screen flex-col items-center justify-center text-center px-4">
          <div className="max-w-4xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/upload-scans"
                className="w-full sm:w-auto px-8 py-4 bg-green-800 text-white font-semibold uppercase tracking-widest hover:bg-green-950 transition-colors rounded-md shadow-lg"
              >
                Start Analysis
              </Link>
              <a
        ...
        {/* Sections for scrolling content */}
            ...
            <FadeInContainer>
              <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 p-8 bg-gray-900/50 border border-gray-800 rounded-2xl shadow-2xl">
                  <AnimatedStatistics value={98} label="Detection Accuracy" />
                  <AnimatedStatistics value={96} label="Classification Precision" />
                  <AnimatedStatistics value={94} label="Tumor Type Identification" />
                </div>
              </div>
            </FadeInContainer>
          </section>
